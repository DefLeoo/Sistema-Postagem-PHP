      ...
      <div class="row">
        ...
        <div class="col-sm-8">
          <div class="panel-usuario">
            <ol class="breadcrumb">
              ...
              <li><a href="ver-postagem.php"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>  Visualizar Postagens</a></li>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <h3 class="panel-title"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>  Editar Postagem</h3>

          </div>

<?php

 //Recuperear e atualizar os dados para editar
     ...
     try
     {
      ...
      if($contar>0)
      {
        ...
        echo' <div class="alert alert-success">
                "<strong>Atualizado</strong> com sucesso"
              </div> ';

      } else
      {
        echo'<div class="alert alert-danger">
              "Erro ao atualizar <strong>dados</strong>"
             </div> ';
      }
    ...
    <div class="panel-body ">
      ...
      <div class="control-group">
        <form action="" method="POST" enctype="multipart/form-data">
          ...
          <div class="controls">
            <input type="text" id="titulo" value="<?php echo $titulo;?>" class="" name="titulo">
          </div> <!-- /controls -->       
      </div> <!-- /control-group -->
      ...
      <div class="control-group">                     
        ...
        <div class="controls">
          <input type="text" class="span6" id="data" name="data" value="<?php echo $data;?>">
        </div> <!-- /controls -->       
      </div> <!-- /control-group -->
      ...
      <div class="control-group">                     
        ...
        <div class="controls">
          ...
          <img src="../upload/<?php echo $novoNome;?>" width="50px"/>
        </div> <!-- /controls -->       
      </div> <!-- /control-group -->
      ...
      <div class="control-group">                     
        ...
        <div class="controls">
          <textarea class="span4" name="descricao" id="descricao" cols="80" rows="10" ><?php echo $descricao;?></textarea>
        </div> <!-- /controls -->       
      </div> <!-- /control-group -->
